...
uint8_t bz_init(s_bz *self, s_bz_init attr);
...
uint8_t bz4_init(s_bz4 *self, s_bz4_init_attr attr);
uint8_t bz4_eval(s_bz4 *self, vlf_t x, vlf_t *value);
...
inline uint8_t bz_init(s_bz *self, s_bz_init attr)
{
	uint32_t i;
...
inline uint8_t bz_deriv(s_bz *self, vlf_t t, vlf_t *deriv)
{
	vlf_t temp = 1 - t;
...
inline uint8_t bz_eval(s_bz *self, vlf_t t, vlf_t *value)
{
...
inline uint8_t bz4_init(s_bz4 *self, s_bz4_init_attr attr)
{
	uint32_t i;
...
inline uint8_t bz4_d0(s_bz4 *self, vlf_t t, vlf_t *d0)
{
	vlf_t t_ = 1 - t;
...
inline uint8_t bz4_d1(s_bz4 *self, vlf_t t, vlf_t *d1)
{
	vlf_t t_ = 1 - t;
...
inline uint8_t bz4_d2(s_bz4 *self, vlf_t t, vlf_t *d1)
{
...
inline uint8_t bz4_d3(s_bz4 *self, vlf_t t, vlf_t *d1)
{
...
inline uint8_t bz4_inv (s_bz4 *self, vlf_t t, vlf_t *x)
{
	vlf_t roots[4];
...
inline uint8_t bz4_d0t(s_bz4 *self, vlf_t t, vlf_t *value)
{
	vlf_t d0[2];
	vlf_t d1[2];
	vlf_t x;
...
inline uint8_t bz4_d1t(s_bz4 *self, vlf_t t, vlf_t *value)
{
	vlf_t d0[2];
	vlf_t d1[2];
	vlf_t d2[2];
...
inline uint8_t bz4_d2t(s_bz4 *self, vlf_t t, vlf_t *value)
{
	vlf_t d0[2];
	vlf_t d2[2];
	vlf_t d3[2];
